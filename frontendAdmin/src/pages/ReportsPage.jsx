...
function ReportModal({ report, onClose, onActionComplete }) {
  ...
  const handleResolve = () => performAction("resolved");
  const handleRejectClick = () => setShowRejectModal(true);
  const handleRejectConfirm = (reason) => performAction("rejected", reason);
          ...
          <table className="w-full min-w-[880px]">
            <thead className="text-left text-[11px] uppercase tracking-widest text-muted bg-black/20">
              <tr className="border-b border-border">
                ...
                <th>Status</th>
                <th>Date</th>
                <th className="pr-15 text-right">Action</th>
              </tr>
            </thead>
            <tbody>
                            ...
                            <div className="inline-flex items-center justify-end gap-2">
                              ...
                              <button
                                ...
                                title={
                                  canDelete
                                    ? "Delete report"
                                    : "Resolve or reject this report before deleting"
                                }
                                aria-label="Delete report"
                                className={`h-9 w-9 inline-flex items-center justify-center rounded-xl transition shrink-0 ${
                                  canDelete
